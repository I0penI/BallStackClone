...
public class BallController : MonoBehaviour
{
    ...
    [SerializeField]
    private TMP_Text ballCountText = null;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("BallStack"))
        {
            ...
            other.gameObject.transform.localPosition = new Vector3(0f, 0f, balls[balls.Count - 1].transform.localPosition.z - 1);
    ...
    private void IncreseBallCount()
    {
        for (int i = 0; i < gateNumber; i++)
        {
            ...
            newBall.transform.localPosition = new Vector3(0f, 0f, balls[balls.Count - 1].transform.localPosition.z - 1);
            balls.Add(newBall);
        }
    }
